...
<head>
    ...
    <!-- Titre du site -->
    <title>Enchere ENI - Mes articles</title>
							...
							<div class="col-5">
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="radio"
										...
										onchange="changeRadioBox()"> <label
										class="form-check-label" for="radioAchat">Achats</label>
								</div>
								<div class="form-check">
									<input class="form-check-input" type="checkbox"
										name="checkbox1RadioAchat" id="checkbox1RadioAchat" value="option2">
									<label class="form-check-label" for="checkbox1RadioAchat">Mes
										enchères</label>
								</div>
								<div class="form-check">
									<input class="form-check-input" type="checkbox"
										name="checkbox2RadioAchat" id="checkbox2RadioAchat" value="option3">
									<label class="form-check-label" for="checkbox2RadioAchat">Mes
							...
							<div class="col-4">
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="radio"
										...
										onchange="changeRadioBox()"> <label
										class="form-check-label" for="radio2">Vente</label>
								</div>
								<div class="form-check">
									<input class="form-check-input" type="checkbox"
										name="checkbox1RadioVente" id="checkbox1RadioVente" value="checkbox1RadioVente"
										disabled> <label class="form-check-label"
										for="checkbox1RadioVente">Mes ventes en cours</label>
								</div>
								<div class="form-check">
									<input class="form-check-input" type="checkbox"
										name="checkbox2RadioVente" id="checkbox2RadioVente" value="checkbox2RadioVente"
										disabled> <label class="form-check-label"
										for="checkbox2RadioVente">Ventes non débutées</label>
								</div>
								<div class="form-check">
									<input class="form-check-input" type="checkbox"
										name="checkbox3RadioVente" id="checkbox3RadioVente" value="checkbox3RadioVente"
										disabled> <label class="form-check-label"
										for="checkbox3RadioVente">Ventes terminées</label>
								</div>
							</div>
						</div>
						<div class="row justify-content-center">
