							...
							<div class="col-lg-8">
								...
								<div class="form-group row">
									<label for="dateDebutEncheres" class="col-2 col-form-label">Date
										début enchère</label>
									<div class="col-10">
										<input class="form-control" type="date" value="${LocalDate.now().plusDays(1)}"
								...
								<div class="form-group row">
									<label for="dateFinEncheres" class="col-2 col-form-label">Date
										fin enchère</label>
									<div class="col-10">
										<input class="form-control" type="date" value="${LocalDate.now().plusDays(2)}"
								...
								<div class="form-group row">
									...
									<div class="col-10">
										<input id="rue" name="rue"
											class="form-control" type="text" value="${sessionUtilisateur.rue}"maxlength="50" required>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-10">
										<input id="codePostal" name="codePostal"
											class="form-control" type="text" value="${sessionUtilisateur.codePostal}"
								...
								<div class="form-group row">
									...
									<div class="col-10">
										<input id="ville" name="ville"
											class="form-control" type="text" value="${sessionUtilisateur.ville}" maxlength="30" required>
									</div>
								</div>
